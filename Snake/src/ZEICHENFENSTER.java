...
public class ZEICHENFENSTER {
   ...
   * @param y      y-Koordinate des Mittelpunkts
   * @param radius Kreisradius
   * @param farbe  F�llfarbe f�r den Kreis, erlaubt sind "weiss" "schwarz" "rot" "gruen" "blau"
   ...
   * @param xPos,yPos Koordinaten der linken oberen Ecke
   * @param breite,   hoehe Breite und H�he des Rechtecks
   * @param farbe     F�llfarbe f�r das Rechteck, erlaubt sind "weiss" "schwarz" "rot" "gruen"
   *                  "blau" "gelb" "magenta" "cyan" "grau"
   */
   ...
   * @param x2,y2 Koordinaten des zweiten Eckpunkts
   * @param x3,y3 Koordinaten des dritten Eckpunkts
   * @param farbe F�llfarbe f�r das Dreieck, erlaubt sind "weiss" "schwarz" "rot" "gruen" "blau"
   *              "gelb" "magenta" "cyan" "grau"
   */
   ...
   * @return gibt eines booleschen Wert zur�ck, der angibt, ob das Bild vollst�ndig geladen werden
   * konnte
   */
  ...
  /**
   * Wartet eine bestimmte Zeit. Eine kurze Verz�gerung kann z. B. f�r Animationen verwendet
   * werden.
   *
   ...
   *
   * @param element Das einzuf�gende Steuerungselement muss aus JComponent abgeleitet sein. z. B.
   *                JButton, JComboBox.
   */
